...
$res = mysql_query("UPDATE cats SET cnm='".$cnm."', mnm='".$mnm."' WHERE id='".$iidd."'");
echo mysql_error();
if($res){
...
$old = mysql_fetch_array(mysql_query("SELECT cnm, mnm FROM cats WHERE id='".$iidd."'"));
?>										
                    ...
                    <div class="col-md-6">
                     <input class="form-control input-lg" name="cnm" value="<?php echo $old[0];?>" type="text">
                    </div>
                    </div>
                    ...
                    <div class="col-md-6">
                     <input class="form-control input-lg" name="mnm" value="<?php echo $old[1];?>" type="text">
                    </div>
                    </div>
