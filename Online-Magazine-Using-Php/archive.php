...
$dta = date("jS F Y", $tmst);

$titleOfMe = "$basetitle - $dta";
?>
...
<h3 class="category-headding "><a href="#"><?php echo $dta; ?></a></h3>
...
$count = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM news WHERE hide='0' AND tm BETWEEN '".$tmst."' AND '".$tmend."' ORDER BY id DESC"));
...
$ddaa = mysql_query("SELECT id, ttl, thumb, btext, tm FROM news WHERE hide='0' AND tm BETWEEN '".$tmst."' AND '".$tmend."' ORDER BY id DESC");
    echo mysql_error();
